...
class App {
    ...
    async loadStore() {
        ...
        try {
            ...
            if(items.length === 0) {
                // Dummy Data loaded using Rupees
                items = [
                    { name: "Carbon Fiber Steering", price: 35000, image: "logo.PNG" },
                    { name: "Akrapovic Exhaust Tips", price: 15000, image: "logo.PNG" },
                    { name: "Ambient Light Kit", price: 8000, image: "logo.PNG" }
                ];
            }
